...
import { ClipboardIcon, ArrowDownTrayIcon, ArrowPathIcon, PencilIcon, CheckIcon, CodeBracketIcon, EyeIcon, SparklesIcon } from '@heroicons/react/24/outline'
import { pdf } from '@react-pdf/renderer'
import { CvDocument } from '@/documents/CvDocument'
import { type ThemeId } from '@/documents/themes'
import { type SSEBenchmark } from '@/hooks/useSSEStream'
          ...
          <div className="mb-6 p-4 sm:p-6 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-zinc-800 dark:to-zinc-800 rounded-lg border border-purple-200 dark:border-zinc-700">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              <div className="bg-white dark:bg-zinc-700 rounded-lg p-4 border border-pink-100 dark:border-zinc-600">
                ...
                <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">First render in UI</div>
              </div>
              ...
              <div className="bg-white dark:bg-zinc-700 rounded-lg p-4 border border-blue-100 dark:border-zinc-600">
                ...
                <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">Stream completion</div>
              </div>
              ...
              <div className="bg-white dark:bg-zinc-700 rounded-lg p-4 border border-green-100 dark:border-zinc-600">
                ...
                <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">Final render</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4">
              <div className="bg-white dark:bg-zinc-700 rounded-lg p-4 border border-gray-200 dark:border-zinc-600">
                <div className="text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">Total Chunks</div>
                <div className="text-xl font-bold text-gray-900 dark:text-gray-100">{benchmarkMetrics.chunkCount}</div>
              </div>
              <div className="bg-white dark:bg-zinc-700 rounded-lg p-4 border border-gray-200 dark:border-zinc-600">
                <div className="text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">Data Size</div>
              ...
              <div className="bg-white dark:bg-zinc-700 rounded-lg p-4 border border-gray-200 dark:border-zinc-600">
                <div className="text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">Avg Chunk Size</div>
                <div className="text-xl font-bold text-gray-900 dark:text-gray-100">
                  {benchmarkMetrics.averageChunkSize > 1024
                    ? `${(benchmarkMetrics.averageChunkSize / 1024).toFixed(2)}KB`
                    : `${benchmarkMetrics.averageChunkSize.toFixed(0)}B`
                  }
                </div>
              </div>
            </div>
